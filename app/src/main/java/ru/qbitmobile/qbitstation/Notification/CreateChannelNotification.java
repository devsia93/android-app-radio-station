...
import ru.qbitmobile.qbitstation.Service.OnClearFromRecentService;

public class CreateChannelNotification {

    public static void create(Context context){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            createChannel(context);
          /*  context.registerReceiver(broadcastReceiver, new IntentFilter("RADIO_STATION"));
